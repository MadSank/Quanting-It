...
class SessionManager:
    ...
    def start_session(self, challenge: str):
        ...
        self.current_session.start_session(challenge)
        self.current_session.activate()
        
    def verify_sequence_number(self, sequence_number: int) -> bool:
        if not self.current_session:
            return False
        try:
            self.current_session.consume_sequence(sequence_number)
            return True
        except SessionError:
            return False
